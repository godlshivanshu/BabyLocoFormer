...
from babylocoformer.assets.quadruped import QUADRUPED_CFG  # isort:skip

from . import mdp
from .eventcfg import EventCfg
...
@configclass
class BabylocoformerSceneCfg(InteractiveSceneCfg):
...
@configclass
class BabylocoformerEnvCfg(ManagerBasedRLEnvCfg):
    # Scene settings
    scene: BabylocoformerSceneCfg = BabylocoformerSceneCfg(num_envs=4096, env_spacing=4.0)
    # Basic settings
